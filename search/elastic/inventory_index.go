	...
	err := es.createIndex(iname,
		&types.TypeMapping{
			Properties: map[string]types.Property{
				...
				"collection_id":   &types.IntegerNumberProperty{Store: &no, Index: &yes},
				...
				"core_name":       &types.TextProperty{Store: &no, Index: &yes},
				"core_unit":       &types.TextProperty{Store: &no, Index: &yes},
				"top":             &types.FloatNumberProperty{Index: &yes},
				"bottom":          &types.FloatNumberProperty{Index: &yes},
				"interval_unit":   &types.TextProperty{Store: &no, Index: &yes},
				"keywords":        &types.TextProperty{Index: &yes},
				"barcode":         &types.TextProperty{Index: &yes},
				"display_barcode": &types.TextProperty{Store: &no, Index: &yes},
				"container_id":    &types.IntegerNumberProperty{Store: &no, Index: &yes},
				"path_cache":      &types.TextProperty{Store: &no, Index: &yes},
				"remark":          &types.TextProperty{Index: &yes},
				"project_id":      &types.IntegerNumberProperty{Store: &no, Index: &yes},
				"project":         &types.TextProperty{Store: &no, Index: &yes},
				"can_publish":     &types.BooleanProperty{Index: &yes},
				"description":     &types.TextProperty{Store: &no, Index: &yes},
