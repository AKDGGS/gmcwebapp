SELECT w.well_id AS id,
	...
	w.unit::text,
	json_agg(json_build_object('ID', o.organization_id, 'Name', o.name, 'Remark', o.remark, 'Type', ot.name, 'Current', wo.is_current) ORDER BY wo.is_current DESC) AS "Organizations"
	FROM well AS w
